...
<li><i>Projects:</i> have an own clouds folder for each customer project.</li>
<li><i>Customers</i>: add all partner files in a single directory available both from Odoo and from clouds. Modify those using default cloud editors and access them when working in Odoo.</i></li>
