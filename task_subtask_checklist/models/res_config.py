...
#         help="Restrict Task Progress Before All Checklist Either Canceled Or Completed.")
    group_checklist_task_progress_restriction = fields.Boolean("Task Progress Restriction", implied_group='task_subtask_checklist.group_checklist_task_progress_restriction')
